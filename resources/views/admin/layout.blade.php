        ...
        <aside class="fixed inset-y-0 left-0 z-30 flex w-64 flex-col bg-[#222d32] shadow-xl">
            ...
            <nav class="flex-1 overflow-y-auto py-4">
                <ul class="space-y-0.5 px-3">
                    ...
                    <li>
                        <a href="{{ route('admin.orders.index') }}" class="flex items-center gap-3 rounded-md border-l-4 border-transparent px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.orders.*') ? 'border-[#3c8dbc] bg-white/10 text-white' : 'text-[#b8c7ce] hover:bg-white/5 hover:text-white' }}">
