...
<div class="space-y-6">
        ...
        <div class="p-6">
            <div class="flex flex-wrap gap-8">
                ...
                <div class="rounded-xl bg-slate-50 p-6 min-w-[180px]">
                    ...
                    <div class="mt-1 text-sm text-slate-500">Products synced</div>
                </div>
            </div>
        </div>
    </div>
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <div class="p-6 flex flex-wrap gap-3">
            ...
            <a href="{{ route('admin.products.index') }}" class="inline-flex items-center gap-2 rounded-xl bg-slate-800 px-5 py-2.5 font-medium text-white shadow-sm transition-all hover:bg-slate-700">
