...
<head>
    ...
    <style>
        ...
        .otp { font-size: 28px; font-weight: 700; letter-spacing: 0.2em; color: #18181b; margin: 16px 0; font-family: ui-monospace, monospace; }
...
<body>
    <div class="wrap">
        <div class="card">
            <h1>{{ $isNewEmail ? 'Verify your new email' : 'Verify your email' }}</h1>
            <p>Hi {{ $firstName }},</p>
            <p>Your verification code is:</p>
            <p class="otp">{{ $otp }}</p>
            <p>Enter this code on the verification page. This code expires in {{ $expireMinutes }} minutes.</p>
