...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-surface-950 grain min-h-[calc(100vh-4rem)] flex items-center">
      ...
      <div
        className="absolute top-32 right-[8%] hidden lg:block animate-float opacity-80"
      ...
      >
        <div className="bg-white/8 backdrop-blur-md border border-white/12 rounded-2xl px-4 py-3 flex items-center gap-3 shadow-xl">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-lg">
            🎁
          </div>
          <div>
      ...
      <div
        className="absolute bottom-32 right-[12%] hidden lg:block animate-float opacity-70"
        style={{ animationDelay: '2.5s' }}
      >
        <div className="bg-white/8 backdrop-blur-md border border-white/12 rounded-2xl px-4 py-3 flex items-center gap-3 shadow-xl">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-violet-400 to-purple-500 flex items-center justify-center text-lg">
            ⭐
          </div>
          <div>
      ...
      <div
        className="absolute top-40 left-[6%] hidden xl:block animate-float opacity-60"
