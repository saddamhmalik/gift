...
const THEMES = [
  {
    img: 'from-slate-600   to-slate-900',
    border: 'from-slate-300   via-slate-200   to-purple-300',
    shadow: 'rgba(100,116,139,0.25)',
  },
  {
    img: 'from-violet-600  to-purple-900',
    border: 'from-violet-300  via-purple-200  to-pink-300',
    shadow: 'rgba(139,92,246,0.25)',
  },
  {
    img: 'from-blue-600    to-indigo-900',
    border: 'from-blue-300    via-indigo-200  to-violet-300',
    shadow: 'rgba(99,102,241,0.25)',
  },
  {
    img: 'from-rose-600    to-pink-900',
    border: 'from-rose-300    via-pink-200    to-orange-300',
    shadow: 'rgba(244,63,94,0.25)',
  },
  {
    img: 'from-emerald-600 to-teal-900',
    border: 'from-emerald-300 via-teal-200   to-cyan-300',
    shadow: 'rgba(16,185,129,0.25)',
  },
  {
    img: 'from-amber-600   to-orange-900',
    border: 'from-amber-300   via-orange-200 to-rose-300',
    shadow: 'rgba(245,158,11,0.25)',
  },
  {
    img: 'from-indigo-600  to-blue-900',
    border: 'from-indigo-300  via-blue-200   to-sky-300',
    shadow: 'rgba(79,70,229,0.25)',
  },
  {
    img: 'from-fuchsia-600 to-violet-900',
    border: 'from-fuchsia-300 via-violet-200 to-indigo-300',
  ...
  return (
    ...
    >
      <Link
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.boxShadow = `0 16px 48px ${theme.shadow}`
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.boxShadow = `0 4px 24px ${theme.shadow}`
        }}
      >
        {/* ── Gift card image ── */}
        <div className="relative overflow-hidden rounded-t-[14px]" style={{ aspectRatio: '16/7' }}>
          {showImg ? (
            ...
            <div
              className={`w-full h-full bg-gradient-to-br ${theme.img} flex items-center justify-center relative`}
            >
              {/* Decorative circles */}
